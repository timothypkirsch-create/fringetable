...
const newsletter=document.createElement('section');newsletter.className='recipe-section traffic-newsletter';newsletter.innerHTML='<span class="eyebrow">One overlooked dish each week</span><h2>Get the Weekly Dish</h2><p>Until a dedicated newsletter service is connected, subscription requests go directly to Fringe Table by email.</p><p><a class="button" href="mailto:fringetable@gmail.com?subject=Subscribe%20to%20Fringe%20Table%20Weekly%20Dish&body=Please%20add%20this%20email%20address%20to%20the%20Fringe%20Table%20Weekly%20Dish%20list.">Subscribe by email →</a></p>';
