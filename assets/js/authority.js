...
if(!document.querySelector('script[data-pronunciation-layer]')){const p=document.createElement('script');p.src='/assets/js/pronunciation.js?v=20260831a';p.dataset.pronunciationLayer='true';document.body.appendChild(p)}
...
if(page&&!document.querySelector('.authority-discovery')){
 ...
 sec.innerHTML=`<span class="eyebrow">Go deeper</span><h2>Country, ingredients & practical help</h2><div class="essential-grid">${countryCard}<a class="essential-card" href="/ingredients/"><strong>Specialty Ingredient Glossary</strong><span>Definitions and links for the less-familiar ingredients used across Fringe Table.</span><b>Browse ingredients →</b></a><a class="essential-card" href="/pronunciation/"><strong>Pronunciation & Food Terms</strong><span>English-friendly pronunciation cues, meanings and regional context for unfamiliar dish and ingredient names.</span><b>Learn how to say it →</b></a>${problemCards}</div>`;
...
if(/^\/guides\/?(?:index\.html)?$/.test(path)&&!document.querySelector('.authority-guide-index')){
 const main=document.querySelector('main');if(main){const sec=document.createElement('section');sec.className='recipe-section authority-guide-index';sec.innerHTML=`<span class="eyebrow">Country authority</span><h2>Explore by country</h2><div class="essential-grid"><a class="essential-card" href="/ethiopia/"><strong>Ethiopia</strong><span>Doro Wat, Shiro Wot, Injera, Niter Kibbeh and berbere.</span><b>Explore →</b></a><a class="essential-card" href="/haiti/"><strong>Haiti</strong><span>Soup Joumou, Diri Kole ak Pwa Rouj and Epis.</span><b>Explore →</b></a><a class="essential-card" href="/myanmar/"><strong>Myanmar</strong><span>Mohinga, Lahpet Thoke and fermented tea leaves.</span><b>Explore →</b></a><a class="essential-card" href="/nepal/"><strong>Nepal</strong><span>Momos, Yomari, chutney and timur pepper.</span><b>Explore →</b></a><a class="essential-card" href="/georgia/"><strong>Georgia</strong><span>Lobio, mchadi and Georgian pantry flavors.</span><b>Explore →</b></a></div><span class="eyebrow">Reference tools</span><h2>Ingredients, pronunciation & substitutions</h2><div class="essential-grid"><a class="essential-card" href="/pronunciation/"><strong>Pronunciation & Food Terms</strong><span>Say unfamiliar dish and ingredient names with more confidence.</span><b>Open glossary →</b></a><a class="essential-card" href="substitutions/banana-stem-substitute-for-mohinga.html"><strong>Banana Stem Substitute</strong><span>Practical options for Mohinga.</span><b>Read →</b></a><a class="essential-card" href="substitutions/doro-wat-without-niter-kibbeh.html"><strong>Doro Wat Without Niter Kibbeh</strong><span>What works and what changes.</span><b>Read →</b></a><a class="essential-card" href="substitutions/egusi-seed-substitute.html"><strong>Egusi Seed Substitute</strong><span>Seed-based alternatives and their limitations.</span><b>Read →</b></a><a class="essential-card" href="substitutions/devzira-rice-substitute.html"><strong>Devzira Rice Substitute</strong><span>Practical rice choices for palov.</span><b>Read →</b></a><a class="essential-card" href="substitutions/momos-without-steamer.html"><strong>Momos Without a Steamer</strong><span>Safe home-kitchen steaming setups.</span><b>Read →</b></a><a class="essential-card" href="/ingredients/"><strong>Ingredient Glossary</strong><span>A growing reference connecting unfamiliar ingredients to recipes and guides.</span><b>Browse →</b></a></div>`;main.appendChild(sec)}
}
})();