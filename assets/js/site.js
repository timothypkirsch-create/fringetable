...
const DAILY_RECIPES=[{"name":"Eritrean Taita Fit-Fit (Injera Fit-Fit)","region":"Eritrean Tigrinya foodways / Horn of Africa","slug":"eritrean-taita-fit-fit","group":"horn-northeast-africa","type":"Breakfast / Bread","time":"30 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Taita%20fit-fit.jpg?width=1400","summary":"Eritrean taita fit-fit: torn injera warmed with onion, tomato, tesmi and berbere until the bread absorbs the spicy sauce while retaining some soft, distinct pieces.","story":"The dish is a practical example of how Eritrean kitchens reuse bread without treating leftovers as second-rate food. Injera's sourness and porous surface make it especially good at absorbing tesmi and chile seasoning. Wikimedia Commons' long-standing photograph identifies taita fit-fit as a traditional Eritrean food, while Eritrean-focused home-cooking sources document the same torn-bread, berbere and clarified-butter logic. Because closely related fit-fit is also eaten in Ethiopia, this page does not claim an exclusive national origin; it preserves the Eritrean Tigrinya name and preparation context instead.","shop":[{"label":"Eritrean berbere spice blend","url":"https://www.amazon.com/s?k=Eritrean%20berbere%20spice%20blend"},{"label":"Eritrean tesmi spiced clarified butter","url":"https://www.amazon.com/s?k=Eritrean%20tesmi%20spiced%20clarified%20butter"}]},{"name":"Tibetan Shapale (Sha Balep)","region":"Tibetan communities / Himalayas","slug":"tibetan-shapale-sha-balep","group":"himalayas-south-asia","type":"Fried Meat Pie / Main","time":"1 hr 40 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Shapale.jpg?width=1400","summary":"Tibetan shapale, or sha balep: crisp fried wheat pies wrapped around a juicy beef, cabbage, scallion, ginger and garlic filling.","story":"Tibetan foodways have always reflected altitude, pastoralism, grain availability and movement between farming and nomadic communities. Smithsonian Folklife material emphasizes barley, dairy and meat as important parts of Tibetan food culture while also documenting dumplings and breads for gatherings and special meals. Shapale belongs to that broader bread-and-meat repertoire, but it should not be reduced to a 'fried momo': the wrapper, filling proportions and frying technique give it its own identity. This home recipe follows Lobsang Wangdu's widely published Tibetan method while scaling it to a manageable batch.","shop":[]}];
