...
const DAILY_RECIPES=[{"name":"Grenadian Oil Down","region":"Grenada / Eastern Caribbean","slug":"grenadian-oil-down","group":"caribbean-lowcountry","type":"One-Pot Stew / Main","time":"2 hrs 15 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Cooking%20oil%20down%2003.jpg?width=1400","summary":"Grenadian oil down layers breadfruit, salted meat, callaloo and dumplings in turmeric-scented coconut milk, cooked until the liquid reduces and coconut oil glistens.","story":"Oil down takes its name from its finish: water in the coconut milk cooks away until the separated coconut oil seasons and glosses the packed ingredients. The pot is also a social form. Grenadian cooks describe making it on beaches, over wood fires and for groups in which people contribute ingredients and company. No single meat or vegetable list covers every household. Salted pigtail, salt beef, chicken, fish, crab and meatless versions all appear, but breadfruit and the slow reduction of the coconut-rich pot remain central to the dish's Grenadian identity.","shop":[]},{"name":"Goan Bebinca","region":"Goa, India / Konkan Coast","slug":"goan-bebinca","group":"himalayas-south-asia","type":"Layered Pudding Cake / Dessert","time":"2 hrs 15 min, plus cooling","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Bebinka%20-%20Layer%20cake%20from%20Goa.jpg?width=1400","summary":"Goan bebinca is a rich coconut-milk and egg-yolk pudding cake built one caramelized layer at a time, with ghee between the layers and nutmeg in the batter.","story":"Bebinca is strongly associated with Goan Catholic celebrations, especially Christmas, weddings and other festive tables, and its ingredients and labor-intensive method reflect Goa's Indo-Portuguese culinary history. A popular origin story credits a convent nun and connects seven layers to the hills of Old Goa or Lisbon, but that account is better treated as culinary legend than settled documentary history. What can be observed directly is the dessert's craft: each layer records a separate pass under heat, so a clean slice makes the cook's time and attention visible.","shop":[]},{"name":"Sierra Leonean Cassava Leaf Stew","region":"Sierra Leone / West Africa","slug":"sierra-leonean-cassava-leaf-stew","group":"maghreb-west-africa","type":"Leaf Stew / Main","time":"2 hrs 30 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Saka-saka%20-%20cassava%20leaves%20in%20mortar%20and%20pestle.jpg?width=1400","summary":"Sierra Leonean cassava leaf stew simmers finely ground leaves with beef, smoked fish, groundnut paste, red palm oil, chile and ogiri until dark, tender and glossy.","story":"Cassava leaf stew belongs to the broader Sierra Leonean family of leaf stews often described as plasas or palaver sauces, but the leaf and method are not generic. Cassava leaves are pounded very fine and cooked longer than the more visibly leafy potato-leaf or green-leaf stews. Families and communities differ over proteins, thickening and seasoning; debates about whose cassava leaves are best are part of the dish's living social context. Rice is the expected partner, absorbing the concentrated, smoky sauce rather than functioning as an optional garnish.","shop":[{"label":"unrefined red palm oil for West African cooking","url":"https://www.amazon.com/s?k=unrefined%20red%20palm%20oil%20for%20West%20African%20cooking"},{"label":"ogiri fermented seasoning","url":"https://www.amazon.com/s?k=ogiri%20fermented%20seasoning"}]}];
