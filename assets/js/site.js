...
const DAILY_RECIPES=[{"name":"Ojibwe Manoomin Bagaan Porridge","region":"Great Lakes Ojibwe / Indigenous Americas","slug":"ojibwe-manoomin-bagaan-porridge","group":"indigenous-americas","type":"Breakfast / Porridge","time":"20 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Manoomin%20%28wild%20rice%29.jpg?width=1400","summary":"Ojibwe Manoomin Bagaan Porridge adapted from a Great Lakes Indian Fish & Wildlife Commission recipe, combining cooked manoomin with milk, maple syrup, cranberries, pecans and a small amount of tallow.","story":"GLIFWC describes manoomin as 'the good berry' in Ojibwe and frames the relationship through Ganawenindiwag Manoomin Anishinaabeg - the rice and the people take care of each other. Manoomin is tied to Ojibwe migration histories, Great Lakes stewardship and food sovereignty, not simply to the commercial category called wild rice. GLIFWC serves eleven Ojibwe tribes in Minnesota, Wisconsin and Michigan, so its published porridge recipe is especially useful as a contemporary, community-grounded source. This adaptation stays with information GLIFWC has chosen to make public and does not extend into ceremonial practice.","shop":[{"label":"hand harvested wood parched manoomin wild rice","url":"https://www.amazon.com/s?k=hand%20harvested%20wood%20parched%20manoomin%20wild%20rice"}]}];
