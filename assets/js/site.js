...
const DAILY_RECIPES=[{"name":"Choctaw-Chickasaw Banaha Bread","region":"Choctaw and Chickasaw communities / Indigenous Americas","slug":"choctaw-chickasaw-banaha","group":"indigenous-americas","type":"Corn Bread / Side","time":"1 hr 10 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Corn%20kernels%20in%20bowl%20-%20Massachusetts.jpg?width=1400","summary":"Choctaw-Chickasaw banaha from the Chickasaw Nation's public recipe: a firm cornmeal dough wrapped in softened corn husks and boiled until set, with cooked beans as a documented variation.","story":"Banaha belongs to living Choctaw and Chickasaw foodways centered on corn. The Chickasaw Nation preserves the recipe in its cultural foods collection, while Smithsonian programming has described banaha as a traditional Choctaw cornmeal dish and used it to introduce visitors to Choctaw food culture. The wrapper is functional as well as traditional: softened husks hold the stiff cornmeal mixture together while it cooks in water. Leftover banaha can be sliced and fried, a serving method the Chickasaw Nation also records.","shop":[{"label":"dried corn husks for cooking","url":"https://www.amazon.com/s?k=dried%20corn%20husks%20for%20cooking"}]},{"name":"Somali Laxoox (Canjeero)","region":"Somali communities / Horn of Africa","slug":"somali-laxoox-canjeero","group":"horn-northeast-africa","type":"Fermented Flatbread / Breakfast","time":"10 hrs 30 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/LahohS.jpg?width=1400","summary":"Somali laxoox, called canjeero in southern regions, made as an overnight-fermented wheat-and-sorghum batter and cooked on one side until the surface fills with characteristic holes or 'eyes.'","story":"The Journal of Ethnic Foods survey traces laxoox/canjeero through Somali household knowledge rather than a single standardized recipe. Historically sorghum and maize were important, while refined wheat became increasingly common. Fermented batter is commonly held overnight, and the bread is overwhelmingly associated with breakfast. Respondents paired it with sweet Somali tea, oil and sugar, suqaar, stews, liver, eggs, ghee and other foods. The study also distinguishes heritage cajiin methods and reserved fermented starter, or dhanaanis, from newer and diaspora adaptations.","shop":[{"label":"fine sorghum flour","url":"https://www.amazon.com/s?k=fine%20sorghum%20flour"}]},{"name":"Sri Lankan Kottu Roti","region":"Sri Lanka / South Asia","slug":"sri-lankan-kottu-roti","group":"himalayas-south-asia","type":"Street Food / Main","time":"45 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Kottu.jpg?width=1400","summary":"Sri Lankan kottu roti with chopped godamba-style flatbread, cabbage, carrot, onion, curry leaves, chile and egg worked together over a very hot griddle until the roti absorbs the aromatic seasoning.","story":"Sri Lankan accounts closely associate kottu with evening street-food culture and the percussive clatter of metal blades on a griddle. The Tamil word koththu refers to chopping, which describes the action at the center of the dish. Modern kottu appears in many forms - vegetable, egg, chicken, seafood and cheese among them - so this page does not claim one topping combination is definitive. Instead it focuses on the shared technique: high heat, chopped roti, crisp-tender vegetables and enough seasoned moisture to flavor the bread without turning it soggy.","shop":[{"label":"Sri Lankan roasted curry powder","url":"https://www.amazon.com/s?k=Sri%20Lankan%20roasted%20curry%20powder"}]}];
