...
const DAILY_RECIPES=[{"name":"Armenian Ghapama","region":"Armenia / Caucasus","slug":"armenian-ghapama","group":"caucasus-central-west-asia","type":"Festive Main / Sweet","time":"2 hrs 15 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Ghapama%20in%20Sherep%20Restaurant%2C%20Yerevan.jpg?width=1400","summary":"Armenian ghapama: a whole pumpkin baked with partially cooked rice, dried apricots, raisins, cherries, walnuts, pumpkin seeds, honey, butter and cinnamon until tender enough to open into wedges at the table.","story":"Ghapama's visual drama is part of the dish: the baked pumpkin is carried whole to the table, then cut down its natural ribs so it opens around the fragrant rice filling. Smithsonian foodways documentation notes that the cost of nuts and dried fruit historically helped reserve the dish for feasts and festivals, while regional versions vary in fruit, added pumpkin and even meat. The Goris version presented at the Smithsonian emphasizes dried Armenian apricots and cornelian cherries; this home recipe keeps that fruit-and-nut profile while allowing a clearly labeled dried-cherry substitute.","shop":[{"label":"dried cornelian cherries","url":"https://www.amazon.com/s?k=dried%20cornelian%20cherries"}]}];
