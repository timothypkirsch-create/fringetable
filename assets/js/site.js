...
const DAILY_RECIPES=[{"name":"Pachamanca a la Olla (Andean Home Adaptation)","region":"Peruvian Andes / Quechua foodways","slug":"pachamanca-a-la-olla","group":"indigenous-americas","type":"Covered Pot Feast / Main","time":"2 hrs 30 min, plus marinating","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Pachamanca%20casera.jpg?width=1400","summary":"Pachamanca a la olla adapts Peru's Andean earth-oven feast to a tightly covered home pot, steaming herb-marinated pork and chicken with potatoes, sweet potato, corn and fava beans.","story":"Official Peruvian sources treat pachamanca as both food and a relationship among people, land and agricultural products. Regional versions in Junín, Cusco, Ayacucho, Huánuco, Áncash and elsewhere use different meats, tubers, herbs and accompaniments, and the opening of an earth oven often belongs to harvests, festivals and family gatherings. This recipe follows the contemporary a-la-olla path documented in Peru: meat is marinated with ají and herbs, layered with crops in a lined pot and cooked by trapped steam. It is an invitation to learn the flavors, not a substitute for the collective knowledge or ceremonial setting of a community-made pachamanca.","shop":[{"label":"aji panca paste","url":"https://www.amazon.com/s?k=aji%20panca%20paste"},{"label":"huacatay paste","url":"https://www.amazon.com/s?k=huacatay%20paste"}]},{"name":"Southern Thai Khao Yam (Herbal Rice Salad)","region":"Southern Thailand / Thai-Malay borderlands","slug":"southern-thai-khao-yam","group":"southeast-asia","type":"Rice Salad / Breakfast or Light Meal","time":"1 hr 15 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/2019%2002%20Khao%20yam%20unmixed.jpg?width=1400","summary":"Southern Thai khao yam combines cooled rice with finely cut herbs, crisp vegetables, pomelo, toasted coconut and dried shrimp, tossed at the table with sweet-salty aromatic budu dressing.","story":"Khao yam belongs to the food culture of Thailand's south and shares a borderland conversation with Malay nasi kerabu, but the two should not be collapsed into one recipe. Southern Thai plates may use white, brown or naturally colored rice and change with available herbs, fruit and vegetables. Budu is the anchor: it is simmered with aromatics and palm sugar, then used sparingly to bind many fresh textures. The dish is commonly eaten for breakfast or lunch and rewards precise knife work more than heavy cooking.","shop":[{"label":"budu fermented fish sauce","url":"https://www.amazon.com/s?k=budu%20fermented%20fish%20sauce"},{"label":"dried makrut lime leaves","url":"https://www.amazon.com/s?k=dried%20makrut%20lime%20leaves"}]},{"name":"Armenian Zhingyalov Hats (Herb-Stuffed Flatbread)","region":"Armenian communities of Artsakh and Syunik / South Caucasus","slug":"armenian-zhingyalov-hats","group":"caucasus-central-west-asia","type":"Stuffed Flatbread / Snack or Light Meal","time":"1 hr 20 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Zhingyalov%20hats.jpg?width=1400","summary":"Armenian zhingyalov hats encloses a generous mixture of neutral, aromatic and sour greens in paper-thin unleavened dough, sealed into pointed flatbreads and cooked on a dry griddle.","story":"The abundance of greens is not decorative. Cooks build the filling from several roles: mild leaves form the bulk, aromatic herbs add intensity, and sour or peppery greens keep the mixture lively. The exact plants change with season, place and family knowledge, and Armenian cooks may use far more wild and cultivated greens than a supermarket version can reproduce. Contemporary Armenian restaurants in the diaspora preserve that flexibility; the MICHELIN Guide records a Glendale bakery using more than a dozen varieties while emphasizing that families do not share one mandatory formula.","shop":[]}];
