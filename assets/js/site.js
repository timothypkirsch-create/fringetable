...
const DAILY_RECIPES=[{"name":"Northern Moroccan Bissara (Fava Bean Purée)","region":"Northern Morocco / Maghreb","slug":"moroccan-bissara","group":"maghreb-west-africa","type":"Soup / Dip","time":"9 hrs 30 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Bissara%20%28Moroccan%20Dip%29.JPG?width=1400","summary":"Northern Moroccan bissara made from soaked peeled split fava beans simmered with garlic, olive oil, cumin and paprika, then puréed thick for dipping or loosened into a warming soup.","story":"Bissara is humble food in the most useful sense: inexpensive dried beans become a sustaining breakfast, street-food bowl, family meal or side through long simmering and a generous olive-oil finish. Northern Moroccan accounts particularly associate the fava version with cooler weather and cities such as Chefchaouen. The texture is deliberately flexible. A thick batch can be placed in a communal dish and scooped with bread, while the same purée can be loosened with hot water into a spoonable soup. Cumin, paprika, cayenne or harissa are often offered at the table rather than forced into one fixed heat level.","shop":[{"label":"dried peeled split fava beans","url":"https://www.amazon.com/s?k=dried%20peeled%20split%20fava%20beans"}]},{"name":"Jamaican Festival Fried Dumplings","region":"Jamaica / Caribbean","slug":"jamaican-festival","group":"caribbean-lowcountry","type":"Fried Bread / Side","time":"55 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Festival%20%28food%29%2002.jpg?width=1400","summary":"Jamaican festival fried dumplings with flour, cornmeal, brown sugar and vanilla shaped into tapered logs and fried slowly enough to become deep golden outside and fully tender inside.","story":"Festival is closely associated with Jamaican street food and fish meals, especially escovitch fish, although it also appears beside jerk and other savory dishes. Its elongated shape gives more crisp surface than a round dumpling while leaving enough interior to stay soft. Recipes vary noticeably in the flour-to-cornmeal ratio, sweetness, milk, butter, vanilla and nutmeg, so no single formula should be presented as universal. The important technical point is controlled frying: because the dough contains sugar, oil that is too hot can brown the outside before the center cooks through.","shop":[]}];
