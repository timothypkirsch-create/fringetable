...
const DAILY_RECIPES=[{"name":"Somali Sambuus (Beef Sambusa)","region":"Somali communities / Horn of Africa","slug":"somali-sambuus-beef-sambusa","group":"horn-northeast-africa","type":"Fried Pastry / Snack","time":"1 hr 30 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sambusadish.jpg?width=1400","summary":"Somali sambuus filled with finely crumbled beef, onion, garlic, green chile and warm spice, sealed into thin triangular wrappers and fried until crisp and blistered.","story":"Sambuus should not be reduced to a generic samosa with a Somali label. Somali families have their own wrapper techniques, fillings, spice preferences and serving customs, and Ahmed writes about the pastry as a carrier of memory, migration and community identity. Ramadan is an especially important context: sambuus often appears when the daily fast is broken, but it also belongs at weddings, family gatherings and tea tables. Diaspora kitchens may use tortillas or commercial wrappers for convenience; this recipe instead follows the thin flour-wrapper tradition while keeping the method manageable at home.","shop":[]},{"name":"Azerbaijani Badambura","region":"Azerbaijan / South Caucasus","slug":"azerbaijani-badambura","group":"caucasus-central-west-asia","type":"Pastry / Sweet","time":"2 hrs 45 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Badambura%201.JPG?width=1400","summary":"Azerbaijani badambura made from thin buttered layers of enriched dough wrapped around almond, sugar and cardamom, baked pale and finished with powdered sugar.","story":"Badambura belongs to Azerbaijan's broader culture of festive pastries, where nuts, cardamom, butter and careful shaping appear across sweets served with tea and during Novruz. It is visually distinct because stacked, buttered sheets are rolled into a log, sliced to expose concentric layers, then opened into a small cup for filling. The target is not croissant-like expansion or a dark bakery crust; the pastry is traditionally kept comparatively pale so the layered pattern remains delicate and the almond-cardamom aroma stays central.","shop":[]},{"name":"Newari Chatamari","region":"Newar / Kathmandu Valley, Nepal / Himalayas","slug":"newari-chatamari","group":"himalayas-south-asia","type":"Rice Crepe / Main or Snack","time":"1 hr","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Meat%20Chatamari.jpg?width=1400","summary":"Newari chatamari from the Kathmandu Valley: a thin rice-flour batter spread on a hot pan and cooked covered until the base is set and lightly crisp, with meat and egg as documented variations.","story":"Chatamari is sometimes marketed as 'Nepali pizza,' but that nickname can hide the technique that actually defines it. The base is a rice-flour batter, not a risen wheat dough, and the covered-pan method cooks the top with trapped steam while the bottom sets against a hot iron surface. Newari versions range from plain to topped with egg, minced meat, vegetables or cheese. Rather than treating one topping combination as definitive, this recipe presents meat and egg as one documented branch of a larger Newar preparation.","shop":[]}];
