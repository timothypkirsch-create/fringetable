...
const DAILY_RECIPES=[{"name":"Ghanaian Groundnut Soup (Nkate Nkwan)","region":"Akan traditions / Ghana / West Africa","slug":"ghanaian-groundnut-soup","group":"maghreb-west-africa","type":"Soup / Main","time":"1 hr 35 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Groundnut%20Soup.JPG?width=1400","summary":"Ghanaian nkate nkwan, or groundnut soup: chicken simmered with tomato, onion, ginger and chile in a smooth roasted-peanut broth until nut oil beads rise to the surface.","story":"Groundnut soup belongs to a wider West African family of peanut-based soups and sauces, but Ghanaian nkate nkwan should not be flattened into a generic 'African peanut stew.' Ghanaian cultural sources specifically connect the soup with Akan cooking, while touring guides document it beside banku, fufu and omo tuo. Odebode also describes the Ghanaian technique as distinct from the shortcut version her family developed after moving to the United States: roasted peanuts are traditionally ground with water and cooked until thick before joining the meat broth. That technical detail matters because properly cooked peanut paste loses its raw, sticky taste and begins to release fragrant oil.","shop":[{"label":"African garden eggs","url":"https://www.amazon.com/s?k=African%20garden%20eggs"},{"label":"natural unsweetened peanut butter","url":"https://www.amazon.com/s?k=natural%20unsweetened%20peanut%20butter"}]},{"name":"Trinidad Aloo Pie","region":"Indo-Trinidadian / Trinidad and Tobago / Caribbean","slug":"trinidad-aloo-pie","group":"caribbean-lowcountry","type":"Street Food / Snack","time":"1 hr 20 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/FOOD%20Aloo%20Pie%207.jpg?width=1400","summary":"Trinidad aloo pie: soft fried dough wrapped around a geera-seasoned potato filling, served hot with tamarind or mango chutney and optionally split open for curried channa.","story":"Aloo pie belongs specifically to Trinidad and Tobago's Indo-Caribbean food culture. The Hindi word aloo means potato, reflecting the language and food knowledge Indian indentured migrants carried to Trinidad beginning in the nineteenth century. Those traditions developed locally into a street-food repertoire that includes doubles, pholourie, saheena and aloo pie. It is tempting to call the pie simply a 'large samosa,' but the local form has its own soft fried dough, elongated shape, potato seasoning and vendor serving style. Contemporary sources also note that Debe in southern Trinidad is especially associated with stalls selling this family of Indo-Trinidadian snacks.","shop":[{"label":"Trinidad chadon beni green seasoning","url":"https://www.amazon.com/s?k=Trinidad%20chadon%20beni%20green%20seasoning"},{"label":"Trinidad tamarind chutney","url":"https://www.amazon.com/s?k=Trinidad%20tamarind%20chutney"}]}];
