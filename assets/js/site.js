...
const DAILY_RECIPES=[{"name":"Southern Vietnamese Bánh Xèo","region":"Southern Vietnam / Southeast Asia","slug":"southern-vietnamese-banh-xeo","group":"southeast-asia","type":"Crisp Pancake / Main","time":"1 hr 10 min","image":"https://commons.wikimedia.org/wiki/Special:FilePath/B%C3%A1nh%20x%C3%A8o.jpg?width=1400","summary":"Southern Vietnamese bánh xèo with a thin turmeric rice-flour and coconut batter, pork, shrimp and bean sprouts cooked until audibly crisp and served with herbs, lettuce and nước chấm.","story":"Vietnamese cooks and food writers describe bánh xèo as both street food and a highly social dish because the crisp pancake is commonly broken into pieces, wrapped in lettuce and herbs, then dipped in nước chấm. Regional distinctions matter: central Vietnamese forms can be smaller and differently seasoned, while southern examples are often broad, turmeric-yellow and coconut-enriched. The dramatic sizzle is more than a name; it signals that the pan is hot enough to drive moisture from the batter quickly and create the brittle lace that separates good bánh xèo from a soft crepe.","shop":[{"label":"Vietnamese fish sauce","url":"https://www.amazon.com/s?k=Vietnamese%20fish%20sauce"}]}];
