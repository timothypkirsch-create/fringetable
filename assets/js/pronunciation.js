...
['chickasaw pashofa','CHIK-uh-saw puh-SHOH-fuh','Chickasaw / Indigenous Americas','A Chickasaw dish of cracked white corn traditionally cooked with pork.'],
['circassian chicken','ser-KASH-un CHIK-in','Circassian / Caucasus','Poached chicken dressed with a seasoned walnut sauce.'],
['ebci bean and hominy','E-B-C-I been and HOM-uh-nee','Eastern Band of Cherokee Indians','Bean-and-hominy preparation documented by the Eastern Band of Cherokee Indians.'],
['ebci black walnut pound cake','E-B-C-I black WAWL-nuht pound cake','Eastern Band of Cherokee Indians','Black-walnut pound cake associated with Eastern Cherokee community cooking.'],
['ebci blue corn tortillas','E-B-C-I bloo corn tor-TEE-yahs','Eastern Band of Cherokee Indians','Blue-corn tortillas presented through Eastern Cherokee community sources.'],
['ghomi with sulguni','GOH-mee with sool-GOO-nee','Georgia / Caucasus','Georgian cornmeal porridge served with sulguni cheese.'],
['rachan lobiani','RAH-chahn loh-bee-AH-nee','Racha, Georgia','Georgian bean-filled bread associated with the Racha region.'],
['nkate nkwan','n-KAH-teh n-KWAHN','Ghana / Akan','Akan name for Ghanaian groundnut soup.'],
['ghanaian red red','gah-NAY-un red red','Ghana','A Ghanaian bean stew commonly served with fried plantain.'],
['goan bebinca','GOH-un beh-BEEN-kah','Goa, India','A Goan coconut-and-egg-yolk dessert baked one layer at a time.'],
['grape dumplings','grayp DUHM-plingz','Cherokee / Indigenous Americas','A contemporary name for grape dumplings rooted in Cherokee foodways.'],
['grenadian oil down','greh-NAY-dee-un oil down','Grenada / Caribbean','Grenada\'s national one-pot dish of breadfruit, coconut milk, greens and other additions.'],
['gullah red rice','GUH-lah red rice','Gullah Geechee / Lowcountry','A tomato-seasoned rice dish from Gullah Geechee foodways.'],
['jamaican brown stew chicken','juh-MAY-kuhn brown stoo CHIK-in','Jamaica','Jamaican chicken browned and braised in a deeply seasoned gravy.'],
['jamaican festival fried dumplings','juh-MAY-kuhn FES-tuh-vuhl fried DUHM-plingz','Jamaica','Slightly sweet Jamaican fried dumplings commonly called festival.'],
['jamaican hominy corn porridge','juh-MAY-kuhn HOM-uh-nee corn POR-ij','Jamaica','Jamaican porridge made with cracked or whole hominy corn.'],
['jamaican rice and peas','juh-MAY-kuhn rice and peez','Jamaica','Jamaican rice cooked with beans, coconut milk and seasonings.'],
['lowcountry hoppin john','LOH-kuhn-tree HOP-in john','Lowcountry / United States','Lowcountry rice and field-pea dish commonly associated with New Year traditions.'],
['lowcountry shrimp and grits','LOH-kuhn-tree shrimp and grits','Lowcountry / United States','A Lowcountry pairing of shrimp and cooked corn grits.'],
['minangkabau beef rendang','mee-NAHNG-kah-bow beef REN-dahng','Minangkabau / Indonesia','Minangkabau beef slowly cooked with coconut and spices until deeply concentrated.'],
['moroccan bissara','muh-ROK-un bih-SAH-rah','Morocco','A Moroccan puree or soup commonly made from dried fava beans or split peas.'],
['newari chatamari','neh-WAH-ree chah-tah-MAH-ree','Newar / Nepal','A Newar rice-flour crepe topped with savory ingredients.'],
['raramuri pinole','rah-RAH-moo-ree pee-NOH-leh','Raramuri / Indigenous Americas','A roasted-ground-corn preparation associated with Raramuri foodways.'],
['roasted squash with maple pepitas','ROH-stid squash with MAY-puhl and peh-PEE-tahs','Indigenous Americas','Roasted squash finished with maple and pumpkin seeds.'],
['sierra leonean cassava leaf stew','see-AIR-ah lee-OH-nee-un kuh-SAH-vuh leef stoo','Sierra Leone / West Africa','A Sierra Leonean stew of finely ground cassava leaves, palm oil and savory seasonings.'],
['somali bariis iskukaris','soh-MAH-lee bah-REES is-koo-KAH-ris','Somalia / Horn of Africa','Somali spiced rice cooked with meat or vegetables.'],
['somali sambuus','soh-MAH-lee sahm-BOOS','Somalia / Horn of Africa','A Somali filled and fried triangular pastry, also called sambusa.'],
['sri lankan watalappam','sree LAHN-kuhn wah-tah-LAH-pahm','Sri Lanka','A Sri Lankan coconut-custard dessert sweetened with jaggery.'],
['trinidad aloo pie','TRIN-ih-dad ah-LOO pie','Trinidad and Tobago','A Trinidadian fried pastry filled with seasoned potato.'],
['tunisian brik','too-NEE-zhuhn breek ah LUHF','Tunisia','A Tunisian crisp pastry containing egg and savory fillings.'],
['west african groundnut stew','west AF-ri-kuhn GROUND-nuht stoo','West Africa','A family of West African stews thickened and flavored with groundnuts.'],
['wild rice cakes with maple','wyld rice kayks with MAY-puhl','Indigenous Americas','Wild-rice cakes served with maple.'],
